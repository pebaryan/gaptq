...
The current diagonal-scaling baseline is still a useful reference:
- it improved `gpt2`
- it hurt `gpt2-medium`
- keep it as a comparator, not a replacement for grade allocation
...
6. if needed, rotor + scaling as a hybrid comparison
