...
| Model | FP16 PPL | RTN PPL | AWQ Proxy PPL | Mean NMSE gain vs RTN | Layers improved | Runtime |
|---|---:|---:|---:|---:|---:|---:|
| `gpt2` | 61.76 | 94.93 | 89.34 | 32.1% | 12/12 | 0.3s |
| `gpt2-medium` | 44.17 | 55.19 | 54.43 | 23.9% | 24/24 | 0.6s |

## AWQ-Style Proxy Interpretation
